...
from school_program_intelligence.shared.models import FloorPlan, Study
...
def all_program_distances(study: Study, mapping: dict[str, str]) -> dict[tuple[str, str], float]:
